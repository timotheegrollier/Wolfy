window.addEventListener('load', () => {
    ...
    class inputHandler {
        constructor() {
            this.keys = [];
            this.touchY = "";
            this.touchTreshold = 30; // longueur du swipe
            window; addEventListener('keydown', (e) => {
                if ((e.key === 'ArrowDown' ||
                    ...
                    // index -1 === n'est pas présent dans le tableau
    ...
    class Player {
        ...
        update(input, deltaTime, enemies) {
            ...
            else if (this.x > this.gameWidth - player.width) this.x = this.gameWidth - player.width
            // Vertical
            this.y += this.vy;
            if (!this.onGround()) {
                this.vy += this.weight
    ...
    function handleEnemies(deltaTime) {
        ...
        // Nouveau tableau d'enemy qui ont passé le test filter()
